 ...
 */
@WebServlet(name="consultarReservasServlet", urlPatterns="/consultarReservasServlet")
public class consultarReservasServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			dispatcher = request.getRequestDispatcher("/mvc/view/Cliente/consultarReservasView.jsp");
