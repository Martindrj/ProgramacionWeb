...
/**
 * Servlet implementation class consultarListasServlet
 */
@WebServlet(name="consultarPistasServlet", urlPatterns="/consultarPistasServlet")
public class consultarPistasServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			dispatcher = request.getRequestDispatcher("/mvc/view/Cliente/listarPistasView.jsp");
