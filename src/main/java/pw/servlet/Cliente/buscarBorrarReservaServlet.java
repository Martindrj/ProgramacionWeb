...
/**
 * Servlet implementation class buscarReservaBorrarServlet
 */
@WebServlet(name="buscarBorrarReservaServlet", urlPatterns="/buscarBorrarReservaServlet")
public class buscarBorrarReservaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			int ida = Integer.parseInt(id);
				...
				dispatcher = request.getRequestDispatcher("/mvc/view/Cliente/borrarReservasView.jsp");
