 ...
 * */
@WebServlet(name="buscarReservaAdminServlet", urlPatterns="/buscarReservaAdminServlet")
public class buscarReservaAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			int ida = Integer.parseInt(id);
				...
				dispatcher = request.getRequestDispatcher("/mvc/view/Admin/modificarReservasAdminView.jsp");
