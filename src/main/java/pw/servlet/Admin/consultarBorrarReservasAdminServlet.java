 ...
 */
@WebServlet(name="consultarBorrarReservasAdminServlet", urlPatterns="/consultarBorrarReservasAdminServlet")
public class consultarBorrarReservasAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			dispatcher = request.getRequestDispatcher("/mvc/view/Admin/consultarBorrarReservasAdminView.jsp");
