...
/**
 * Servlet que implementa la clase consultarPistasAdminServlet.
 * @author Daniel Hinojosa Sanchez
 * @author Martin Del Rio Jimenez
 * @author Juan Antonio Galvez Jimenez
 * */
@WebServlet(name="consultarPistasAdminServlet", urlPatterns="/consultarPistasAdminServlet")
public class consultarPistasAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			dispatcher = request.getRequestDispatcher("/mvc/view/Admin/listarPistasAdminView.jsp");
