 ...
 * */
@WebServlet(name="consultarKartsAdminServlet", urlPatterns="/consultarKartsAdminServlet")
public class consultarKartsAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuarioBean == null || usuarioBean.getCorreo().equals("")) {
			...
			dispatcher = request.getRequestDispatcher("/mvc/view/Admin/listarKartsAdminView.jsp");
