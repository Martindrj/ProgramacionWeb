 ...
 * */
@WebServlet(name="modificarReservaAdminServlet", urlPatterns="/modificarReservaAdminServlet")
public class modificarReservaAdminServlet extends HttpServlet {
			...
			if (numAdultos == 0 && numInfantil != 0 && numInfantil <= DTOpista.getMaxKarts()) {
				if(DTOpista.getDificultad() == Dificultad.infantil) {
					...
					if (DAOreservas.ModificarInfantil(DTOreservaInfantil, prop)) {
						...
						dispatcher = request.getRequestDispatcher("/consultarReservasAdminServlet");
