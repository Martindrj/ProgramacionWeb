...
<body>
	...
	<p class="menusPrincipales">El listado de sus reservas es el siguiente. En caso de querer modificar alguna, introducir los datos que correspondan a la reserva deseada.</p>
	
	<br>
	
	<form class="menusPrincipales" id="form" method="POST" action="/PW-web/buscarReservaAdminServlet">
