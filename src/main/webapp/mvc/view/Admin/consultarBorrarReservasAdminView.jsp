...
<body>
	...
	<h1 class="menusPrincipales">Reservas</h1>
	<p class="menusPrincipales">El listado de las reservas es el siguiente. En caso de querer borrar alguna, introducir los datos que correspondan a la reserva deseada.</p>
	
	<br>
	
	<form class="menusPrincipales" id="form" method="POST" action="/PW-web/buscarBorrarReservaAdminServlet">
