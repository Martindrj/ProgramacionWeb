...
<body>
	...
	<form class="menusPrincipales" id="form" method="POST" action="/PW-web/consultarMisReservasServlet">
		<p>Aplica un rango de fechas si quieres realizar un filtrado.</p>
