...
<body>
	...
	<p class="menusPrincipales">El listado de nuestras pistas es el siguiente.</p>
	
	<br>
	
	<form class="menusPrincipales" id="form" method="POST" action="/PW-web/consultarPistasFiltroServlet">
		<p>Aplica los parametros si quieres realizar un filtrado.</p>
		<table class="alineadoCentro" style="width: 40%">
			<thead>
				<tr>
					...
					<th scope="col" width="20%">
						<label>Número de karts</label> 
					</th>
					<th scope="col" height=2>
			...
			<tbody>
				<tr>
					<td>
						<select id="tipoPista" name="tipoPista" required>
					...
					<td>
						<input type="number" id="numKarts" name="numKarts" placeholder="1" required>
					</td>
			</tbody>
		</table>
	</form>
